package com.project.meetupManager.controller;

import com.project.meetupManager.controller.dto.RegistrationDTO;
import com.project.meetupManager.controller.web.RegistrationController;
...
public class RegistrationControllerTest {
    ...
    private RegistrationDTO createNewRegistration() {
        return  RegistrationDTO.builder().id(101).name("Bruno Henrique").dateOfRegistration("15/09/2021").registration("001").build();
    }
}